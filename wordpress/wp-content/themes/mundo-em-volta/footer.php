...
/**
 * Html do Rodapé.
 * Todas as chamadas de Javascript.
 *
 * PHP version 5
 *
 * LICENSE: Comercial.
...
<!-- end of .content-theme -->

        <div class="clear"></div>

        <div class="footer-social-theme">
        ...
        <footer>
            <div id="footer">
                ...
                <div class="copy-theme">
                    <p>© 2014. All Rights Reserved. mundoemvolta.com</p>
                </div>
                <!-- end of .copy-theme -->
            </div>
        </footer>
