	...
	<!-- .content-right -->
			<div class="content-right">
				...
				<div class="onde-estou-theme">
					...
					<img src="<?php bloginfo('template_url'); ?>/images/mapa.jpg" alt="">
				</div><!-- end of .onde-estou-theme -->

				<div class="social-media-theme">
					<ul>
						<li class="sm-1"><a href="https://www.facebook.com/MundoemVolta" target="_blank">facebook</a></li>
						<li class="sm-2"><a href="https://www.youtube.com/user/mundoemvolta" target="_blank">you tube</a></li>
						<li class="sm-3"><a href="http://instagram.com/mundoemvolta" target="_blank">instagram</a></li>
						<li class="sm-4"><a href="" target="_blank">rss</a></li>
					</ul>
				...
				<div class="anuncie-theme">
					<img src="<?php bloginfo('template_url'); ?>/images/anuncie.png" alt="">
						
				</div><!-- end of .anuncie-theme -->

				<div class="parceiros-theme">
					<img src="<?php bloginfo('template_url'); ?>/images/parceiros.png" alt="">			
